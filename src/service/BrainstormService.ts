...
async function GenerateWords(brainstorm: Brainstorm){
    ...
    try {
        const response = await ai.models.generateContent({
            ...
            config:{
                systemInstruction: "você é um gerador de palavras chaves, responde apenas com palavras chaves, sem cabeçalho, sem explicação, com um espaço e um número inteiro indicando o nível de proximidade com o assunto, que vai de 0 a 3, quanto menor o numero, maior a proximidade. São separadas por vírgula. Dê palavras de todos os níveis"
            }
        });
